...
const rating = computed(() => {
  if (props.review.review_meta?.rating) {
    return Number(props.review.review_meta.rating)
  }
  console.log('Fallback to entity rating', props.review.entity?.rating);
  return Number(props.review.entity?.rating || 0)
})
